...
// static
bool
ScriptablePluginObjectBase::_Invoke(NPObject *npobj, NPIdentifier name, const NPVariant *args, uint32_t argCount, NPVariant *result)
{
                                      ...
                                      NPVariant *result)
{
    ...
    NPUTF8 *putf8ReStr = (NPUTF8 *)NPN_MemAlloc(strlen("default method return val")+1);
    strncpy(putf8ReStr, "default method return val", strlen("default method return val"));
    STRINGZ_TO_NPVARIANT(putf8ReStr, *result);
